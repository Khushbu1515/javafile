    ...
    <div class="card-deck ">
      <div class="card">
        <div style={{ textAlign: "center" }} class="card-body">
          ...
          <h5 class="card-title">{jsonData.map((item) => item.box1)}</h5>
          <br />
          <p class="card-text">{jsonData.map((item) => item.box2)}</p>
        </div>
      </div>
      ...
      <div class="card">
        <div style={{ textAlign: "center" }} class="card-body">
          ...
          <h5 class="card-title">
            {jsonData && jsonData.map((item) => item.box3)}
          </h5>
          <br />
          <p class="card-text">{jsonData.map((item) => item.box4)}</p>
        </div>
      </div>
      <div class="card">
        <div style={{ textAlign: "center" }} class="card-body">
          ...
          <h5 class="card-title">{jsonData.map((item) => item.box5)}</h5>
          <br />
          <p class="card-text">{jsonData.map((item) => item.box6)}</p>
        </div>
      </div>
    </div>
  );
